    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/finalproject/multiplePhotoUpload.do'; 
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'photoUpload.do', //파일업로드시 동작되는 컨트롤러 url
 			sCallback : '/finalproject/resource/editor/photo_uploader/callback.html',  //업로드 이후  redirect 페이지 url
