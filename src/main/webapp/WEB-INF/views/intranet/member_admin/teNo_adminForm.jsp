...
function myFunction3(idx){
	location.href='teacherOk.do?idx='+idx+'&cp='+${cp}+'';
}
function myFunction4(idx){
	location.href='teacherNo.do?idx='+idx+'&cp='+${cp}+'';
}
</script>
...
<div id="content" align="center">
            <div>
                    ...
                    <table class="table" id="table" style="height: 200px; margin-top: 100px; width: 1150px;">                   
                        <thead>
                        <tr>
                         <th style="border: 0px;"><font size="5">미승인 교사보기</font></th>
                         
                                 <td colspan="6" align="right">
                                 <form name="te" action="teNoSearch.do">                                 
