...
function myFunction(id){	
	location.href='banChange.do?groupchild='+ele+'&id='+id+'&cp='+${cp}+'';
}
function myFunction2(idx){
	location.href='teDelete.do?idx='+idx+'&cp='+${cp}+'';
}
...
<div id="content" align="center">
                ...
                <div>
                    <table class="table" id="table" name="select" style="height: 200px; margin-top: 100px; width: 1150px;">                   
                        <thead>
                        <tr>
                         <th style="border: 0px;"><font size="5">승인된 교사보기</font></th>
                               <td colspan="6" align="right">
                                 <form name="te" action="teSearch.do">                                 
                                 <input type="text" name="tesearch" placeholder="교사이름 입력">
                                 <input type="submit" value="검색">
                                 </form>
                               </td>
                        </tr>
                            <tr>
                                <th style="border: 0px;">교사이름</th>
                                <th style="border: 0px;">교사 전화번호</th>
                                <th style="border: 0px;">교사 아이디</th>
                                <th style="border: 0px;">반 이름</th>
                                <th style="border: 0px;">반 지정하기</th>
                                <th style="border: 0px;">퇴사</th>                                                               
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <c:forEach var="dto" items="${list}">
                            ...
                            <tr>
                                ...
                                <td>
                                  <input type="button" value="퇴사" onclick="myFunction2('${dto.idx}')" class="btn btn-warning">
                                </td>
                         ...
                         <c:forEach var="search" items="${list2}">
                            ...
                            <tr>
                                ...
                                <td>${search.id}</td>
                                <td>
                                <c:if test="${search.groupchild==null}">
                                                                        미지정
                                </c:if>
                                <c:if test="${search.groupchild!=null}">
                                ${search.groupchild}
                                ...
                                <td>
                                <select onchange="select(${search.idx})" id="sel1_${search.idx}">
                                ...
                                <input type="button" value="반 수정" class="btn btn-warning" onclick="myFunction('${search.id}')">
                                </td>
                                <td>
                                  <input type="button" value="퇴사" onclick="myFunction2('${search.idx}')" class="btn btn-warning">
                                </td>
