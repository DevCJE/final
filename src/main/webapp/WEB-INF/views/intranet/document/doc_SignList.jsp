...
<section class="wrapper">
   <div id="content">
      ...
      <div name="signlist" align="center">
         <table class="table" width="800" border="0">
            ...
            <c:if test="${empty signlist }">
               <tr align="center">
                  <td colspan="3">결재 할 서류가 없습니다</td>
               </tr>
            </c:if>
            <c:forEach var="sign" items="${signlist }">
               <tr align="center">
                  <c:url var="pIdx" value="doc_docView.do?">
                     <c:param name="fileurl" value="${sign.document }" />
                     <c:param name="idx" value="${sign.idx }" />
                     <c:param name="name2" value="${sign.name2 }" />
                  </c:url>
                  <td><a href="${pIdx }">${sign.subject }</a></td>
                  <td>${sign.confirm_date }</td>
                  <td>${sign.name1 }</td>
               </tr>
            </c:forEach>
         </table>
