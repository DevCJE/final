...
myFunction = function(i){
   ...
   youFunction1 = function(i){
      ...
      ajax_state=2;
      createXMLHttpRequest();
       var url = "ajaa.do?idx="+i+"&roll_info=1&date="+date+"&roll_class="+roll_class+"";
		$("#info_"+i).removeClass();
...
youFunction2 = function(i){
   ajax_state=2;
   createXMLHttpRequest();
    var url = "ajaa.do?idx="+i+"&roll_info=2&date="+date+"&roll_class="+roll_class+"";
    $("#info_"+i).removeClass();
...
youFunction3 = function(i){
   ajax_state=2;
   createXMLHttpRequest();
    var url = "ajaa.do?idx="+i+"&roll_info=3&date="+date+"&roll_class="+roll_class+"";
    $("#info_"+i).removeClass();
...
youFunction4 = function(i){
   ajax_state=2;
   createXMLHttpRequest();
    var url = "ajaa.do?idx="+i+"&roll_info=4&date="+date+"&roll_class="+roll_class+"";
    $("#info_"+i).removeClass();
	$("#info_"+i).addClass("warning");
    xmlHttp.onreadystatechange = loader;
    xmlHttp.open("GET", url, true);
...
youFunction5 = function(i){
   ajax_state=2;
   createXMLHttpRequest();
    var url = "ajaa.do?idx="+i+"&roll_info=5&date="+date+"&roll_class="+roll_class+"";
    $("#info_"+i).removeClass();
...
youFunction6 = function(i){
   ajax_state=2;
   createXMLHttpRequest();
    var url = "ajaa.do?idx="+i+"&roll_info=6&date="+date+"&roll_class="+roll_class+"";
    $("#info_"+i).removeClass();
	$("#info_"+i).addClass("warning");
    xmlHttp.onreadystatechange = loader;
    xmlHttp.open("GET", url, true);
