...
<div class="content">
		<div class="col-md-6 col-md-offset-3">
				<form class="writeForm" action="itn_msg_Write.do" method="post">
					<div class="form-group">
							<input type="hidden" name="recv_name" value="${param.recv_name}">

								<select name="send_name" class = "form-control">
					...
					<div class="form-group">
						<textarea rows="20" cols="40" class="form-control" name="content" placeholder="내용을 입력하세요..." style="resize:none;"></textarea>
					</div>
					<div class="form-group">
					<button type="submit" class="btn btn-warning btn-block">쪽지보내기</button>
					</div>
 				</form>
		</div>
	</div>
