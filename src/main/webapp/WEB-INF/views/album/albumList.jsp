...
<section>	
	<article>
		<div class="row">
		    <div id="contert_header" class="col-xs-12">
        <form name = "dateSearch"  id = "dateSearch" action = "albumCalender.do">     	
        	<div class="main_title">   	
				...
				<div class="container">
					<div class="album_list_img">
					<c:if test="${empty list}">
						<div>
							등록된 사진이 없습니다.
						</div>
							<td colspan="4" align="center">등록된 사진이 없습니다.</td>
					</c:if>
		          	...
		          	<c:url var="albumUri" value="albumContent.do">
						...
						<div class="thumbnail">
							<div class="thumbnail_title well">${dto.idx}.&nbsp;&nbsp;${dto.album_subject}</div>
							<div>
	               				<img src="${dto.album_photo}" id = "albumimg" alt="ALT NAME">
	               			</div>
	               			<div class="caption text-right">
	               			<br>
	                 			<small>View: ${dto.album_viewer}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                 			[${dto.album_date}]</small>                			               			
