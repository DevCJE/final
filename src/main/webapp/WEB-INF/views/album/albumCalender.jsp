...
<section>	
	<article>
        ...
        <form name = "dateSearch"  id = "dateSearch" action = "albumCalender.do">
				...
				<div class="container">
					<div class="row ">
					<c:if test="${empty albumcalender}">
						<div class="text-center">
							해당 날짜 검색된 앨범이 없습니다.
						</div>
					</c:if>
		      		<c:forEach var="calender" items="${albumcalender}">
		          	<c:url var="albumcalenderUri" value="albumContent.do">
		          		<c:param name="idx">${calender.idx}</c:param>
		          	</c:url>
						<div class="album col-xs-4 text-center">
						<div class="thumbnail" >
							<div class="thumbnail_title well">${calender.idx}.&nbsp;&nbsp;${calender.album_subject}</div>
							<div>
	               				<img src="${calender.album_photo}" id = "albumimg" alt="ALT NAME">
	               			</div>
	               			<div class="caption text-right">
	               			<br>
	                 			<small>View: ${calender.album_viewer}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                 			[${calender.album_date}]</small>               			
	                			<p align="center"><br><a href="${albumUri}" class="btn btn-primary btn-block">open</a></p>
	           				</div>           
	             		 </div>
