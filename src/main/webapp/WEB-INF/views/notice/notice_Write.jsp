...
<body>
	<div class="container">
		<div class="col-xs-9 col-xs-offset-2">
			<br/><br/>공지사항 <br/><br/>
				<form class="writeForm" action="notice_Write.do" method="post" id="frm">
					<div class="form-group">
							<input type="text" class="form-control" name="subject" placeholder="제목을 입력하세요...">
					</div>
					<div class="form-group">
						<textarea rows="20" cols="40" class="form-control" name="content" placeholder="내용을 입력하세요..." style="resize:none;" id="editor"></textarea>
					</div>
					<div class="form-group">
					<button type="submit" class="btn btn-primary btn-block" id="savebutton">작성하기</button>
