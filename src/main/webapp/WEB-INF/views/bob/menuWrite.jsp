...
<form name="bobWrite" action="menuWriteOk.do" method="post" enctype="multipart/form-data">
  
       <div class = "container">
          <div style="margin-top: 50px;"><h2>${menu_date}일 식단표 작성하기</h2></div>
               ...
               <div class="thumbnails">
            	  <div class="col-md-4">
                     ...
                     <input type="text" name="bob1_name" class="form-control" required="required">
                     <p style="padding-top: 15px;">음식 원산지 입력</p>
			         <textarea rows="7" cols="36" name="bob1_content" required="required"></textarea>			         
                    ...
                    <p style="padding-top: 15px;">음식 이름 입력</p>
                    <input type="text" name="bob2_name" class="form-control" required="required">
                     <p style="padding-top: 15px;">음식 원산지 입력</p>
                    <textarea rows="7" cols="36" name="bob2_content" required="required"></textarea>
                    <div class="filebox bs3-primary preview-image" style="margin-top: 10px;">
                     ...
                     <p align="center" style="padding-top: 15px;"><font size="5">오후간식</font></p>                       
                      <p style="padding-top: 15px;">음식 이름 입력</p>
                      <input type="text" name="bob3_name" class="form-control" required="required">
                      <p style="padding-top: 15px;">음식 원산지 입력</p>
                      <textarea rows="7" cols="36" name="bob3_content" required="required"></textarea>
                      <div class="filebox bs3-primary preview-image" style="margin-top: 10px;">
