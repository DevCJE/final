...
<body>
	...
	<section>
		...
		<div class="container">
				<div class="col-md-12">
				    <div class="form-area">  
				        <form role="form" action="noteUpdateOk.do">
				         <br style="clear:both">
				                    <h3 style="margin-bottom: 25px; text-align: center;">알 림 장 수 정</h3>
				                    ...
				                    <div class="form-group">				                    
				                    	<textarea class="form-control" name="note_content" rows="5" id="editor">${dto.note_content}</textarea>
				                   		<textarea class="form-control" name="note_need" placeholder="준비물" maxlength="140" rows="7">${dto.note_need}</textarea>                
				                    </div>
				                  		   <div>
