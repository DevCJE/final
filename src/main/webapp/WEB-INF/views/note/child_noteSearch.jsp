	...
	<article>
		<div class="container">
			...
			<div class="header" style="margin-top: 20px;" >
	        	...
	        	<div>
	        <%-- <div>
			<input type="text" id="datepicker" name="calender" class="btn btn-default" value="날짜선택하기"><br>
			</div>
			
				<p align="right" >
						<div>
							<c:if test="${sessionScope.auth == 4 || sessionScope.auth == 5}">
							<button type="button" onclick="location.href='noteWriteForm.do'">글쓰기</button>
							</c:if>
								
							</div>
						
						<div class="ser">
							<form name="search" method="post" action="noteSearch.do">
		            ...
		            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		               ...
		               <div class="thumbnail">
		                ...
		                <fmt:setLocale value="ko" scope="session"/>
		                  <h3><fmt:formatDate value="${dto.note_writedate}" pattern="yyyy년 MM월 dd일"/><font style="font-weight: bold;"> 알림장</h3>
		                  <div class = "col-xs-offset-3">
		                  <img src="${dto.note_img}" id = "noteimg" alt="ALT NAME">
		                  </div>
		                  <p align="center"><a href="noteContent.do?idx=${dto.idx}&note_idx=${dto.idx}" class="btn btn-primary btn-block">세부사항 확인</a></p>
		                </div>
		                </div>
		              </div>
		          	 </div>
